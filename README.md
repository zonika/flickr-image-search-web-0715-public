...
5. In **js/flickrSearch.js** write the code neccesary to capture the user's search term upon clicking the search button and send out an AJAX request to the Flicker API. Using the provided link and API key:
